...
color: #0F172A
paginate: true
header: 'ENGLABS INVENTORY Command OS (Light Mode)'
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/01_login_screen.png)

- **Secure Login**: Access the terminal using your **Fleet Identity** (Email) and **Access Key**.
- **Branding**: The interface features the new **ENGLABS INVENTORY** identity with a clean, high-contrast light theme.
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/02_dashboard.png)
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/03_sales_terminal.png)
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/04_inventory.png)
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/05_staff.png)
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/06_financials.png)
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/07_purchases.png)
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/08_suppliers.png)
...
![bg right:60% fit](releases/v2.0.0/screenshots/light/09_support.png)
